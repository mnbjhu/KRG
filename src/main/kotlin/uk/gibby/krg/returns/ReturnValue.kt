...
import uk.gibby.krg.returns.primitives.PrimitiveReturn
 ...
 * Return value
 *
 * A value which can be returned from a graph query: [uk.gibby.krg.core.Graph].
 * i.e. RETURN myValue
...
abstract class ReturnValue<T>{
     ...
     * E.g.
     *
     * - [uk.gibby.krg.returns.primitives.LongReturn] -> 23
     * - [uk.gibby.krg.returns.primitives.StringReturn] -> 'Some String'
